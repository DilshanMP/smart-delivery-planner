    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Role: {{ ucwords(str_replace('_', ' ', $role->name)) }}</h3>
            </div>
            <form action="{{ route('roles.update', $role) }}" method="POST">
                                                ...
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input module-permission"
                                                               ...
                                                               data-module="{{ strtolower(str_replace(' ', '_', $moduleName)) }}"
                                                               {{ in_array($group['permissions'][$action], old('permissions', $rolePermissions)) ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                ...
                <div class="card-footer">
                    ...
                    @if(!in_array($role->name, ['admin', 'manager', 'coordinator', 'viewer']))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete the <strong>{{ ucwords(str_replace('_', ' ', $role->name)) }}</strong> role?</p>
