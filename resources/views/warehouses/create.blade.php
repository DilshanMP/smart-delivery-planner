                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @error('address')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                        <small class="form-text text-muted">Click on map to auto-fill address</small>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @error('latitude')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">Click map to set location</small>
                            </div>
                        </div>
        ...
        <div class="card card-info sticky-top" style="top: 10px;">
            ...
            <div class="card-footer">
                <small class="text-muted">
                    <i class="fas fa-info-circle"></i> Click on the map to set warehouse location
                </small>
            </div>
        </div>
    </div>
...
@push('scripts')
<!-- Simple Map Implementation (No API Key Required) -->
